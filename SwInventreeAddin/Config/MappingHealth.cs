namespace SwInventreeAddin.Config
{
    ...
    public enum MappingHealth
    {
        ...
        /// <summary>Schema version does not match the current version. Fetch is allowed, but Apply, Push, Create Part, and BOM Compare are locked until the file is saved with the current schema.</summary>
        NeedsUpgrade,
