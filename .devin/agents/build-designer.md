...
- **Watch items** — edge cases and ordering constraints a reviewer must verify on the built diff; `none` when empty. The orchestrator copies them verbatim into the reviewer SPEC block.
