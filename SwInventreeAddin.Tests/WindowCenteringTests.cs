...
namespace SwInventreeAddin.Tests
{
    ...
    public class WindowCenteringTests
    {
        ...
        {
            var owner = new WindowCentering.RECT { Left = 100, Top = 100, Right = 500, Bottom = 400 };
            var dialog = new WindowCentering.RECT { Left = 0, Top = 0, Right = 200, Bottom = 100 };
        ...
        {
            var owner = new WindowCentering.RECT { Left = -200, Top = -100, Right = 200, Bottom = 200 };
            var dialog = new WindowCentering.RECT { Left = 0, Top = 0, Right = 200, Bottom = 100 };
        ...
        {
            var owner = new WindowCentering.RECT { Left = 50, Top = 50, Right = 150, Bottom = 150 };
            var dialog = new WindowCentering.RECT { Left = 0, Top = 0, Right = 300, Bottom = 200 };
        ...
        {
            var owner = new WindowCentering.RECT { Left = 100, Top = 100, Right = 500, Bottom = 400 };
            var dialog = new WindowCentering.RECT { Left = 20, Top = 30, Right = 220, Bottom = 130 };
