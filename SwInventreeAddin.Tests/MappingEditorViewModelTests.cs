...
namespace SwInventreeAddin.Tests
{
    ...
    public class MappingEditorViewModelTests
    {
        ...
        [Test]
        public void CanCopyToLocal_WhenSharedOlderMapping_IsTrue()
        {
            var provider = new StubPropertyMappingProvider
            {
                IsReadOnly = true,
        ...
        [Test]
        public void CanCopyToLocal_WhenSharedHealthyMapping_IsFalse()
        {
            var provider = new StubPropertyMappingProvider
            {
                IsReadOnly = true,
        ...
        [Test]
        public void CanCopyToLocal_WhenLocalOlderMapping_IsFalse()
        {
            var provider = new StubPropertyMappingProvider
            {
                IsReadOnly = false,
        ...
        [Test]
        public void CopyToLocal_WhenSharedOlderMapping_SetsInstructionAndDisablesButton()
        {
            var provider = new StubPropertyMappingProvider
            {
                IsReadOnly = true,
